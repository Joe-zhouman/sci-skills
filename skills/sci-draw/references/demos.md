...
The bundled examples live under `../assets/figures4papers/`. They are Python/matplotlib
reference materials. Keep the normal figure contract first:
define the scientific claim, then adapt a demo pattern.
...
4. Use `export_figure(formats=['pdf', 'png'])` for export. See `api.md` for palettes and helpers.
